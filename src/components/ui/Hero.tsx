...
export default function Hero() {
  return (
    <section className="w-full overflow-x-clip px-3 md:px-5 pt-8 pb-20 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183ec2,#eaeefe_100%)]">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <figure className="mt-20 md:mt-0 md:h-[648px]  md:flex-1 xl:flex-0 md:relative ">
            <Image
              src={cogImage}
              alt="cog"
            ...
            <Image
              ...
              width={220}
              height={220}
              className="hidden md:block -top-8 xl:top-5 xl:-left-7 -left-32 md:absolute"
            />
            <Image
              src={noodleImage}
              alt="noodle"
